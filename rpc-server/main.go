...
import (
	"log"
	"context"
	rpc "github.com/dtzr09/IM_service/rpc-server/kitex_gen/rpc/imservice"
...
func main() {
	...
	if err_db := db_client.InitClient(ctx,"user06:password@tcp(imdb)/messaging_service"); err_db != nil {
